...
{
    /// <summary>
    /// Class CustomWebViewRenderer.
    /// </summary>
    public partial class CustomWebViewRenderer : ViewRenderer<CustomWebView, CustomWebViewRenderer.NativeWebView>
    {
        /// <summary>
        /// Allows one to override the Webview Client class without a custom renderer.
        /// </summary>
        public static Func<CustomWebViewRenderer,Client> GetWebViewClientDelegate;

        /// <summary>
        /// Allows one to override the Chrome Client class without a custom renderer.
        /// </summary>
        public static Func<CustomWebViewRenderer, ChromeClient> GetWebChromeClientDelegate;
        ...
        public class Client : WebViewClient
        {
            ...
            /// The web hybrid
            /// </summary>
            protected readonly WeakReference<CustomWebViewRenderer> WebHybrid;
...
//                }
                ...
                //{
                //    Console.WriteLine($"OnScroll - distinctX:{distanceX}, distinceY:{distanceY}");
